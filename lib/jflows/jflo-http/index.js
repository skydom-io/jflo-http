...
module.exports = function(jflo) {
    jflo.flow("http", function(config) {
            ...
            // Make sure the URL starts with a http:// or https:// protocol designator
            if ((url_param.indexOf('http://') != 0) && (url_param.indexOf('https://') != 0)) {
            ...
            if (params.debug) {
                config.logger.debug.write({method: method, url: url_param});
            }
